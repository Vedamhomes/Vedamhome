      ...
      <div className="xl:mx-auto xl:container">
        <div className="bg-[#fff9f0] flex flex-col-reverse md:flex-row items-center lg:space-x-6">
          ...
          <div className="w-full flex lg:w-1/2 lg:pl-12 h-[40vh] sm:h-[50vh] md:h-auto">
            ...
            >
              <h1 className=" font-[Hues] font-thin text-[14px] mt-4 sm:mt-0 sm:text-[18px] tracking-[0.2em] uppercase text-[#634730]">
                Exciting News
              </h1>
              ...
              <motion.p
                ...
                className="font-[Hues] font-light text-[16px] sm:text-[24px] uppercase text-[#634730] tracking-[0.1em] leading-relaxed max-w-xs sm:max-w-lg border border-[#7a6e66] px-4 sm:px-6 py-3 sm:py-4 rounded-lg shadow-md bg-white/50 backdrop-blur-sm   sm:mt-8 md:mt-12"
              >
