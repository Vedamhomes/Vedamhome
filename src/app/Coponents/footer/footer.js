  ...
  return (
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-4">
        <div className="flex flex-col flex-shrink-0">
            ...
            <p className="text-sm leading-none text-gray-800 mt-4">Copyright © 2021 Vedam Homes</p>
            ...
            <div className="flex items-center gap-x-4 mt-12">
                ...
                <div>
                <FontAwesomeIcon className='cursor-pointer w-6 h-6' icon={faInstagram} flip style={{color: "#d80e40",}} />
                </div>
                <div>
                <FontAwesomeIcon className='cursor-pointer w-6 h-6' icon={faFacebook} beat style={{color: "#3b5998",}} />
                </div>
                <div>
                <FontAwesomeIcon className='cursor-pointer w-6 h-6' icon={faLinkedin} beatFade style={{color: "#0077B5",}}/>
                </div>
                <div>
                <FontAwesomeIcon className='cursor-pointer w-6 h-6' icon={faYoutube} fade style={{color: "#FF0000",}} />
                </div>
            </div>
        </div>
