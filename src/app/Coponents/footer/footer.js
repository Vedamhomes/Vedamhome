...
const Footer = () => {
  return (
    <footer className={`bg-[#fff9f0] z-20 text-[#634730] pt-10 pb-6 px-4 relative`}>
      <div className="mx-auto flex flex-col md:flex-row justify-between items-start text-left">
