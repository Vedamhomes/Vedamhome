...
const WhatSetUsApart = () => {
  ...
  return (
    <div className="bg-[#fff9f0]">
      ...
      <div className="mt-10 font-[hues] flex flex-row justify-center px-10">
